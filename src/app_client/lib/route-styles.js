    ...
    .directive("head", [
      ...
      function($rootScope, $compile, $interpolate) {
        ...
        var startSym = $interpolate.startSymbol(),
          ...
          html = [
            '<link rel="stylesheet" ng-repeat="(routeCtrl, cssUrl) in routeStyles" ng-href="',
            startSym,
            "cssUrl",
            endSym,
            '">'
            ...
            $rootScope.$on("$routeChangeSuccess", function(
              ...
              if (previous && previous.$$route && previous.$$route.css) {
                ...
                if (
                  current.$$route &&
                  current.$$route.css &&
                  !angular.isArray(current.$$route.css)
                ) {
                ...
                angular.forEach(previous.$$route.css, function(sheet) {
                  if (
                    !current.$$route ||
                    !current.$$route.css ||
                    current.$$route.css.indexOf(sheet) === -1
                  ) {
